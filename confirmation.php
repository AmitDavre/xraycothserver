					                ...
					                <div style="display:  flex;"> <i style="font-size: 33px;" class="fa fa-user-secret" aria-hidden="true" ></i> &nbsp;&nbsp;  <h3> Confirmation Text</h3> </div>
					                    <div style="float:left;overflow-y: auto;height: 387px;margin-top: 36px;">
					                    	<h4 style="padding: 36px;line-height: 28px;">
					                    		...
					                    		<ul>
					                    			<li>Terms & Condition <span style="margin-left: 17px;">:</span> <span style="margin-left: 28px;<?php if($termsConsent == '1'){echo 'background-color:#080;font-weight: 600;';}else{echo 'background-color:#c00;font-weight: 600;';}?>"><?php echo $termsAgreed ?></span> on <span style="font-weight: 600;"><?php echo $terms_consent_date;?></span></li>

					                    			<li>Privacy Policy <span style="margin-left: 65px;">:</span> <span style="margin-left: 28px;<?php if($privacyConsent == '1'){echo 'background-color:#080;font-weight: 600;';}else{echo 'background-color:#c00;font-weight: 600;';}?>"><?php echo $privacyAgreed ?></span> on <span style="font-weight: 600;"><?php echo $privacy_consent_date;?></span></li>

					                    			<li>Cookie Consent <span style="margin-left: 44px;">:</span> <span style="margin-left: 28px;<?php if($cookieConsent == '1'){echo 'background-color:#080;font-weight: 600;';}else{echo 'background-color:#c00;font-weight: 600;';}?>"><?php echo $cookieAgreed ?></span> on <span style="font-weight: 600;"><?php echo $cookie_consent_date;?></span></li>
					                    		</ul>
					                    	</h4>	
                        				...
                        				<div style="margin-top: 30px;">
							                <h4 style="padding: 36px;line-height: 28px;text-align: center;">

							                You will be redirected automatically to dashboard in <span id="time_count">3</span><span> seconds</span>
							                </h4>
		...
		$( document ).ready(function() {
			...
			var interval = setInterval(function() {
			    ...
			    if (counter <= 0) {
			     	...
			     	// run ajax here to reset according to consent settings
			  //    	$.ajax({
					// 	url: "ajax/consent/resetConsent.php",
					// 	success: function(result){
			      			 window.location.href = 'index.php?mn=2';  
					// 	}
					// });
