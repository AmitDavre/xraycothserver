<?php
	...
	unset($_SESSION['rego']['showConsentPage']);
	...
	// check in rego all users table for the consent 
		...
		else
		{
			...
			{
				header('location: '.ROOT.'consent.php');
			}
		}
					    ...
					    <div class="row" style="width: 100%;">
					        <div class="col-md-12">
					            <div class="card cookie p-3">
					                ...
					                <div style="display:  flex;"> <i style="font-size: 33px;" class="fa fa-user-secret" aria-hidden="true" ></i> &nbsp;&nbsp;  <h3> Consent Notice</h3> </div>
					                    <div style="float:left;overflow-y: auto;height: 200px;margin-top: 36px;">
					                    	<h4 style="padding: 36px;line-height: 28px;">If you wish not to agree with our Privacy Policy / Terms & Condition / Cookie Consent you can send an email by pressing the <b>"Send Email To Admin"</b> button. Our administrator will be notified about your consent choices. 
					                    	</h4>	
...
<!-- 
					                		<label>
					                          <input id="privacy-remember" type="checkbox" name="remember" value="1"> By checking this box, I state that I have read and understood the privacy policy.
					                        </label> -->
                        				...
                        				<div style="margin-top: 30px;">
                        					...
                        					<button  style="float: right;background: #080;border-color: #080;color: #fff;margin-right: 5px;" class="btn  " id="sendEmailToAdmin" type="button"><i style="font-size: 15px;" class="fa fa-envelope" aria-hidden="true"></i> Send Email To Admin</button>
                        					<button  style="float: right;background: #080;border-color: #080;color: #fff;margin-right: 5px;" class="btn  " id="privacyAgreee" type="button"><i style="font-size: 15px;" class="fa fa-check-circle" aria-hidden="true"></i> Continue To Consent</button>
