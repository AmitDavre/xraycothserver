	...
	if($res103 = $dba->query($sql103)){
		if($res103->num_rows > 0){
			if($row103 = $res103->fetch_assoc())
				{
					$privacy_consentValue = $row103['privacy_consent'];  
					$privacy_consent_change = $row103['privacy_consent_change'];   
	...
	{
		// check here if privacy change value = 1 then show privacy div here 

		if($privacy_consent_change != '1')
		{
