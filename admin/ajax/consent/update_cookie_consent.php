<?
	...
	$sql103 = "SELECT * FROM rego_users WHERE username = '".$email."'";
	...
	$insertIntoLog= " INSERT INTO `rego_consent_log`(`name`, `cid`,`consent_name`, `consent_date`,`user_name`,`cookie_consent`,`cookie_consent_date`,`consent_status`) VALUES ('".$name."','','Cookie Consent', '".$cookie_consent_date."','".$email."','".$cookieConsentValue."','".$cookie_consent_date."','".$cookieConsentValue."')" ;
