...
<style>
	...
	<form id="termsForm">
	<h2><i class="fa fa-file-text-o fa-lg"></i>&nbsp;&nbsp;Terms & Conditions<button id="subButton" class="btn btn-primary" style="float:right; margin-top:3px"><i class="fa fa-save"></i>&nbsp; Update</button></h2>
