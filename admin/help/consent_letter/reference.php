<?php
	...
	if($row = $res->fetch_assoc()){
		$th_content = $row['th_reference'];
		$en_content = $row['en_reference'];
	}	
	//var_dump($th_content);
	//var_dump($en_content);
?>
...
<style>
	...
	<form id="termsForm">
		<input type="hidden" name="consent_block" id="consent_block" value="block3">

	<h2><i class="fa fa-file-text-o fa-lg"></i>&nbsp;&nbsp;Text Block 3 : Reference <button id="subButton" class="btn btn-primary" style="float:right; margin-top:3px"><i class="fa fa-save"></i>&nbsp; Update</button></h2>
