      ...
      */
      (function(base, search, replace){
        ...
        var extend = function(a,b){
			...
			var baseURL = window.location.protocol + '//' + window.location.hostname+'/hr'+ base;
            //var baseURL = 'https://wartiz.com/etemp';
            alert(baseURL);
...
<?//include_style('etemp/assets/css/bootstrap.min.css'); ?>
<!-- <link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/smoothness/jquery-ui.css"> -->
<?=include_style('../etempss/assets/css/bootstrap-colorpicker.min.css'); ?>
<?=include_style('../etempss/assets/css/bootstrap-slider.min.css'); ?>
<?=include_style('../etempss/assets/plugins/medium-editor/medium-editor.min.css'); ?>
<?=include_style('../etempss/assets/plugins/medium-editor/template.min.css'); ?>
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/spectrum/1.8.0/spectrum.min.css">
<?=include_style('../etempss/assets/css/style.css'); ?>

<h2><i class="fa fa-envelope"></i>&nbsp; <?=$lng['eMail templates']?></h2>
<div class="main">

	<div class="container-fullscreen">
    	<div class="container text-center">
        	<div id="choose-template" class="text-center hidden">
                <button class="choose" type="button" data-id="no-sidebar">
                	<img src="../etempss/assets/img/no-sidebar.jpg" class="img-responsive" alt="">
                	<span>No Sidebar (wide)</span>
                </button>
                <button class="choose" type="button" data-id="left-sidebar">
                	<img src="../etempss/assets/img/left-sidebar.jpg" class="img-responsive" alt="">
                	<span>Left Sidebar</span>
                </button>
                <button class="choose" type="button" data-id="right-sidebar">
                	<img src="../etempss/assets/img/right-sidebar.jpg" class="img-responsive" alt="">
                	<span>Right Sidebar</span>
                </button>
                <button class="choose" type="button" data-id="both-sidebar">
                	<img src="../etempss/assets/img/both-sidebar.jpg" class="img-responsive" alt="" >
                	<span>Both Sidebars</span>
                </button>
            </div>

        </div>
        <div class="container-content hidden" id="mail-template" style="display: none;">
            Content
        </div>
        <div class="container-sidebar hidden" id="option-tabs">
            ...
            <!--    <div class="get-options choose" data-id="title" id="title"><span class="glyphicon glyphicon-text-size"></span><div>Heading</div></div>  -->
                <div class="get-options choose" data-id="content" id="content"><span class="fa fa-list-alt fa-lg"></span><div>Text</div></div>
                <div class="get-options choose" data-id="image" id="image"><span class="fa fa-image fa-lg"></span><div>Image</div></div>
                <div class="get-options choose" data-id="video" id="video"><span class="fa fa-play fa-lg"></span><div>Video</div></div>
                <div class="get-options choose" data-id="link" id="link"><span class="fa fa-link fa-lg"></span><div>Link</div></div>
                <div class="get-options choose" data-id="divider" id="divider"><span class="fa fa-minus fa-lg"></span><div>Divider</div></div>
    ...
    <button class="btn btn-success btn-materialize btn-left-bottom btn-left-bottom-1 hidden" type="button" id="preview" title="Preview" data-toggle="tooltip" data-placement="top" data-trigger="hover"><span class="fa fa-eye"></span></button>
    ...
    <button  style="left: 100px" class="btn btn-lg btn-default btn-materialize btn-left-bottom btn-left-bottom-3 hidden" type="button" id="setting" title="Layout Options" data-toggle="tooltip" data-placement="top" data-trigger="hover"><span class="fa fa-cog fa-spin"></span></button>      
	...
	<!-- <script src="etemp/assets/js/bootstrap.min.js"></script> -->   
	<script src="../etempss/assets/js/bootbox.min.js"></script>
    <script src="../etempss/assets/js/debounce.js"></script>
    <script src="../etempss/assets/js/bootstrap-colorpicker.min.js"></script>
    <script src="../etempss/assets/js/bootstrap-slider.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/spectrum/1.8.0/spectrum.min.js"></script>
    <script src="//cdn.jsdelivr.net/medium-editor/latest/js/medium-editor.min.js"></script>
    <?=include_script('../etempss/assets/js/creative.tools.js'); ?>
	<?=include_script('../etempss/assets/js/html2canvas.js'); ?>
	<?=include_script('../etempss/assets/js/image-edit.js'); ?>
	<?=include_script('../etempss/assets/js/editor.js'); ?>
