...
*/
	...
	$email->From      = 'pankaj.wartiz@gmail.com';
	$email->FromName  = 'E-mail Template';
	$email->Subject   = 'E-mail Template '.date('F j, Y. H:i:s');
	$email->Body      = str_replace("/\<[\/]{0,1}button[^\>]*\>/i", "", $message);
	$email->IsHTML(true);
