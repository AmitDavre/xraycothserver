			...
			'<div class="modal-dialog'+(s.large?' modal-lg':'')+'">'+
				'<div class="modal-content">'+
					'<div class="modal-header">'+
						(s.close===true?'<button type="button" class="bootbox-close-button close" data-dismiss="modal"><span class="fa fa-times"></span></button>':'')+
						( s.header!="" ? '<h4 class="modal-title">'+s.header+'</h4>' : '' )+
					'</div>'+
