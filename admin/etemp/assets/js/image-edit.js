        ...
        */
        ...
        $('#image-editor-console #new').on('click touchstart',function(e){
            ...
            var id = $.rand(1111,99999)+Math.floor(Date.now() / 1000),
                html = '<div class="text-editor active" style="z-index:99;"><span class="remove" data-type="delete"><span class="fa fa-times" data-type="delete"></span></span><div class="edit-text" contenteditable="true" ondragenter="event.preventDefault(); event.dataTransfer.dropEffect = \'none\'" ondragover="event.preventDefault(); event.dataTransfer.dropEffect = \'none\'" data-id="layer-' + id + '">Edit Text</div></div>',
