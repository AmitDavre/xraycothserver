					            ...
					            <div class="card cookie p-3">
					                ...
					                <div style="display:  flex;"> <i style="font-size: 33px;" class="fa fa-user-secret" aria-hidden="true" ></i> &nbsp;&nbsp;  <h3> Confirmation Text</h3> </div>
					                    ...
					                    <!-- 		<?php 
					                    		...
					                    		if($terms_consent_date != '')
					                    		{
					                    			$termsExplode = explode(' ', $terms_consent_date);
					                    			$termsDate= $termsExplode[0];
					                    			$termsTime= $termsExplode[1];
					                    		}
					                    		else
					                    		{
					                    			$termsDate= '';
					                    		...
					                    		{
					                    			$privacyExplode = explode(' ', $privacy_consent_date);
					                    			$privacyDate= $privacyExplode[0];
					                    			$privacyTime= $privacyExplode[1];
					                    		}
					                    		else
					                    		{
					                    			$privacyDate= '';
					                    		...
					                    		if($cookie_consent_date != '')
					                    		{
					                    			$cookieExplode = explode(' ', $cookie_consent_date);
					                    			$cookieDate= $cookieExplode[0];
					                    			$cookieTime= $cookieExplode[1];
					                    		}
					                    		else
					                    		{
					                    			$cookieDate= '';
												...
												$text = str_replace('{USERNAME}', $_SESSION['rego']['name'], $txt);
												$text = str_replace('{TERMS_DATE}', $termsDate, $text);
												$text = str_replace('{TERMS_TIME}', $termsTime, $text);		
												$text = str_replace('{PRIVACY_DATE}', $privacyDate, $text);
												$text = str_replace('{PRIVACY_TIME}', $privacyTime, $text);												
												$text = str_replace('{COOKIE_DATE}', $cookieDate, $text);
												$text = str_replace('{COOKIE_TIME}', $cookieTime, $text);
                        				...
                        				<div style="margin-top: 30px;">
							                ...
							                You will be redirected automatically to dashboard in <span id="time_count" style="background:yellow;">3</span><span style="background:yellow;"> seconds</span>
							                </h4>
			...
			var interval = setInterval(function() {
			    ...
			    if (counter <= 0) {
			     	...
			     	// run ajax here to reset according to consent settings
						if(userType == 'emp') {
			      			 window.location.href = 'e/index.php';  
						}
						else
						{
