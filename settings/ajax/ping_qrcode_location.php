            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                ...
                <table id="d" class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tr>
                    <td background="#41abe2" bgcolor="#41abe2" width="600" height="50" valign="top" align="center" style=""> 
                        <p style="color: #ffffff; font-size: 21px;text-align: center;font-family: Verdana, Geneva, sans-serif; line-height: 61px; margin: 2px;  padding: 0; float:left; margin-left:19px;">Ping Location Notification for '.$_REQUEST['location_name_value'].'
                          </p>
                      </td>
                  </tr>
                </table>
                ...
                <table id="d" class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0;" bgcolor="#FFFFFF">
                  <tr>
                    <td > 
                        <p style="color:#011e40; font-size: 14px; text-align: left; font-family: Verdana, Geneva, sans-serif; line-height: 20px; margin: -2px; padding: 0; padding: 0px 13px;">Please follow this link to ping your current location from your Phone or Tablet for accurate location submission. <img src="https://regodemo.com/images/loc.png" alt="" width="22" height="22" style="border-width:0; max-width:12px;height:auto; float: none; margin-top: 2px;margin-left:2px;" align="left"/></p><br>
...
<td style="text-align:center; padding:0px 10px 10px 10px;" >
		...
		$mail->addAddress($_REQUEST['contact_email'], 'Test Email'); 
		$mail->isHTML(true);                                  
		$mail->Subject = 'Ping Location For  '.$_REQUEST['location_name_value'].'';
		$mail->Body = $body;
		$mail->WordWrap = 100;
		if(!$mail->send()) {
			echo $mail->ErrorInfo;
