<?
	...
	// $ALemp = getALemployeeOther($cid, $_REQUEST['emp_id'],$cur_year);

	$previousYear = $cur_year -1 ;
	...
	// {
		...
		// $sqlGetAlBAl= "SELECT * FROM ".$cid."_employee_per_year_records WHERE emp_id = '".$_REQUEST['emp_id']."' ";
	...
	$balance = getUsedLeaveEmployeeWithBal($cid, $_REQUEST['emp_id'], $balance, $currentyear, $cur_year);
