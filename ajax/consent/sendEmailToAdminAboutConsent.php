		...
		# code...
				$body = "<html>
						...
						<body style='font-size:16px'>
							...
							<p>Dear Admin,</p>
							<p>Username: ".$_SESSION['rego']['username']." is not accepting our website consent <br>
							<p>Kind regards</p>
						</body></html>";
