<?php
	...
	if($prid){ // RECALCULATE EMPLOYEE ////////////////////////////////////////////////////////////////////////
		$sql = "SELECT * FROM ".$_SESSION['rego']['payroll_dbase']." WHERE id = '".$prid."'";
		 ...
		 $sql = "SELECT * FROM ".$_SESSION['rego']['payroll_dbase']." WHERE entity IN (".$_SESSION['rego']['selpr_entities'].") AND emp_group = '".$_SESSION['rego']['emp_group']."' AND month = '".$_SESSION['rego']['cur_month']."' AND paid = 'C' ORDER by LENGTH(emp_id) ASC, emp_id ASC";
	...
	// TAX SUMMARY ///////////////////////////////////////////////////////////////
			...
			if($row['calc_tax'] == 1){ // PND1 ////////////////////////////////////////////////////////
				...
				if($row['calc_method'] == 'acm'){
					...
					$total_tax_year = $acm_tax_variable; //$acm_tax_variable;
					$tax_previous = $prev_tax;
					$tax_remaining = $acm_tax_variable - $tax_previous; //$acm_tax_variable - $tax_previous;
	...
	// PAYROLL RESULT ////////////////////////////////////////////////////////////
			...
			if($row['calc_base'] == 'gross'){
				...
				$net_month = $gross_income_month - $tot_deduct_after;
	...
	// PAYROLL OVERVIEW ////////////////////////////////////////////////////////////////
		...
		//if($tot_var_all == '4950'){
			...
			$ytd_incomeNew = $gross_income_month - $tot_non_all;
