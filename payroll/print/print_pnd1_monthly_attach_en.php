...
<style>
	...
	if($body2){
		...
		foreach($body2 as $k=>$v){
			$tot_income2 += str_replace(',','',$v['grossincome']);
			$tot_tax2 += str_replace(',','',$v['tax']);
		...
		$html .= '
				<tr>
					<th colspan="4" style="text-align:right"><b>Total amount of income and withholding tax remittance</b>&nbsp;&nbsp;(to be included with other attachement of P.N.D.1 (if any))</th>
					<th style="text-align:right; vertical-align:bottom"><b>'.number_format($tot_income2,2).'</b></th>
					<th style="text-align:right; vertical-align:bottom"><b>'.number_format($tot_tax2,2).'</b></th>
					<th></th>
				</tr>
				</tbody>
			</table>';
