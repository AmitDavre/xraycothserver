<?php
	...
	foreach($emps as $k=>$v){
		...
		if($res = $dbc->query("SELECT gross_income, ytd_income, tax_month, pvf_employee, psf_employee, social FROM ".$_SESSION['rego']['payroll_dbase']." WHERE emp_id = '".$k."' ".$addCondition." AND paid IN ('Y','H') ")){
	...
	$html .= '
				<div class="field13n" style="top:23mm;left:163mm">'.$countEmp.'</div>
