			...
			<div class="row" style="xborder:1px solid green; padding:20px 25px">
				<div class="col-12">
					<div class="page-header">
						<h4 class=""><?=$lng['Terms & Conditions Consent']?></h4>
					</div>
					<div class="divider-icon">
						...
						<fieldset>
							...
							<div class="form-group">
								<button  disabled="disabled" id="termsAgree" style="font-size:16px" type="button" class="saveTerms btn btn-default btn-block"><?=$lng['I agree']?></button>
								<button  style="font-size:16px;margin-bottom: 40px;" type="button" class="disagreeTerms btn btn-danger	 btn-block"><?=$lng['I do not agree']?></button>
							</div>
