<?php
	...
	$urlexplode = explode('/mob', APP_PATH);

	// print_r($urlexplode[0]);
	...
	if($row = $res->fetch_object()){
		...
		// $pathvar = ROOT;
		$pathvar = $urlexplode[0].'/'.$edata['logofile'];
		// die();
		...
		$html .= '
			...
			<table border="0" style="width:100%">
				<tr>';
					 $html .= '<td style="width:10px;padding:0 20px 0 0; vertical-align:top"><img style="height:50px;max-width:350px" src="'.$pathvar.'" /></td>';
