	...
	$(document).ready(function() {
		...
		$('#govBox-entities').mnSumoSelect({ 
			placeholder: 'Entities',
			//captionFormat:'Entities ({0})', 
			//captionFormatAllSelected:'All Entities',
			csvDispCount: 1, 
			search: false, 
			//searchText:'Search ...', 
			//selectAll:false,
		...
		$('#govBox-entities').on('change',function(e){
			//alert($(this).val());
			updateAccess('gov_entities', $(this).val()); 
		});
		$('#govBox-branches').mnSumoSelect({ 
			placeholder: 'Branches',
			//captionFormat:'Branches ({0})', 
			//captionFormatAllSelected:'All Branches',
			csvDispCount: 1, 
			//search: false, 
			//searchText:'Search ...', 
			//okCancelInMulti:false,
		...
		$('#govBox-branches').on('change',function(e){
			//alert($(this).val()); 
			updateAccess('gov_branches', $(this).val());
		});
