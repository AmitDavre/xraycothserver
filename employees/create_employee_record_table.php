<?
	...
	$sql200dd01 = "ALTER TABLE `$db_name20dd001` ADD `website_status`  VARCHAR(255)  NULL AFTER `attach3`, ADD `website_name` VARCHAR(255) NULL AFTER `website_status`, ADD `contact_info_status` VARCHAR(255) NULL AFTER `website_name`, ADD `c_company` VARCHAR(255) NULL AFTER `contact_info_status`, ADD `c_address` TEXT NOT NULL AFTER `c_company`, ADD `c_function` VARCHAR(55) NULL AFTER `c_address`, ADD `c_telephone` VARCHAR(55) NULL AFTER `c_function`, ADD `c_email` VARCHAR(55) NULL AFTER `c_telephone`;";
