<?
	...
	echo "UPDATE " . $cid . "_sys_settings ' SET c_company_temp = '" . $_REQUEST['field1'] . "', c_address_temp = '" . $_REQUEST['field2'] . "', c_function_temp = '" . $_REQUEST['field3'] . "', c_telephone_temp = '" . $_REQUEST['field4'] . "', c_email_temp = '" . $_REQUEST['field5'] . "'";
