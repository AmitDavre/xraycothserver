...
// $sql = "SELECT link_expire FROM ".$cId."_location  WHERE loc_id = '".$id."'";

// if($result = $dbe->query($sql)){
// 	if($row_value = $result->fetch_assoc()){

// 		if($row_value['link_expire'] == '1')
// 		{
...
<html lang="en-us">
    ...
    <link rel="stylesheet" href="https://xray.co.th/hr/assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://regodemo.com/assets/css/login_RegoDemo.css?<?=time()?>">
		...
		<script src="https://xray.co.th/hr/assets/js/bootstrap.min.js"></script>
...
<script type="text/javascript">
	...
	// 	geolocation.getCurrentPosition(showPosition, errorHandler, {enableHighAccuracy: true, timeout: Infinity, maximumAge: 0});
...
// } 
	...
	function pingLocation()
	{
		...
		$.ajax({
					url: "../ajax/save_external_location.php",
					data: {id: id,latitude:latitude,longitude:longitude,cId:cId},
